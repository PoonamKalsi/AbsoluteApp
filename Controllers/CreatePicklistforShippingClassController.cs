...
{
    public class CreatePicklistforShippingClassController : ApiController
    {
        // GET api/<controller>
        public HttpResponseMessage Get(HttpRequestMessage request, string BatchId, string Shippingclass, string UserId="")
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("SplitPicklistAsPerShippingClass", con1))
                    {
